...
export const LANGUAGES: Language[] = [
  ...
  { code: 'nl', label: 'Dutch', nativeLabel: 'Nederlands', suggestPrompt: 'Bekijk in het Nederlands?' },
  ...
  { code: 'ar', label: 'Arabic', nativeLabel: 'العربية', rtl: true, suggestPrompt: 'عرض بالعربية؟' },
  ...
  { code: 'zh-CN', label: 'Chinese (Simplified)', nativeLabel: '简体中文', suggestPrompt: '查看简体中文？' },
];
