...
- **Pressable** — `whileTap: scale 0.98`, typed on `HTMLMotionProps<'div'>` (not `ComponentProps<'div'>` — framer-motion's drag handlers conflict with the native DOM ones otherwise).
